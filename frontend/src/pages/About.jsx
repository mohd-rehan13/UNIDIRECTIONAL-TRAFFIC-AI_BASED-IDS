  ...
  return (
    <div>
      ...
      <div className="card" style={{ marginBottom: '2rem', borderLeft: '4px solid var(--accent-cyan)' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', padding: '1rem', background: 'rgba(0,0,0,0.1)' }}>
      ...
      <div className="card" style={{ marginBottom: '2rem' }}>
        ...
        <div className="grid-3" style={{ marginTop: '1rem' }}>
          <div style={{ background: 'rgba(0,0,0,0.25)', padding: '1.2rem', borderRadius: '10px', border: '1px solid var(--border-color)' }}>
            ...
            <ul style={{ paddingLeft: '1.2rem', color: 'var(--text-secondary)', fontSize:)', fontSize: '0.85rem' }}>
